...
{
    [Activity(Name = "kiosksample.droid.views.StartView", Label = "KioskSample", MainLauncher = true,
    ...
    public class StartView : MvxActivity<StartViewModel>
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            _deviceAdminComponentName = new ComponentName(this, Class.FromType(typeof(AdminReceiver)).Name);
